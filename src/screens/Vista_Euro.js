...
export default class Vista_Euro extends React.Component {
  state = {
    dataEuro: '',
  }
  componentDidMount = () => {
    ...
    console.log(fechita);
    fetch(`https://si3.bcentral.cl/SieteRestWS/SieteRestWS.ashx?user=196998594&pass=mCHniBD5Qcs6&firstdate=2022-12-05&lastdate=${fechita}&timeseries=F072.CLP.EUR.N.O.D&function=GetSeries`,{
      method: 'GET',
    })
        ...
        <SafeAreaView style={styles.container2}>
          ...
          <Hyperlink linkDefault ={true} >
            <Text style={styles.sectionDes}>
              Hacer click en https://si3.bcentral.cl/Bdemovil/BDE/Series/MOV_BD_TC2?nombreItem=Euro%20%28pesos%20por%20euro%29&nombrePadre=Tipos%20de%20cambio&idPadre=MB_TC&parametroMenu=ViewCategoria&idMenuTree=MB_TC6 
            </Text>
          </Hyperlink>
        </SafeAreaView>
        <View>
          <Text style={styles.title3}>
              Informacion sobre el Euro
          </Text>
        </View>
        <View>
